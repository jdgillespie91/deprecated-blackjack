...
card_list_two = [[9,'9'], [8,'8'], [7,'7'], [6,'6'], [5,'5'], [4,'4'], [3,'3'], [2,'2'], [1,'A']]
...
# no_bj_2
card_list_one = [[10,'K'], [10,'Q'], [10,'J'], [10,'10'], [9,'9'], [8,'8'], [7,'7'], [6,'6'], [5,'5'], [4,'4'], [3,'3'], [2,'2'], [1,'A']]
...
# no_bj_3
card_list_one = [[11,'A'], [9,'9'], [8,'8'], [7,'7'], [6,'6'], [5,'5'], [4,'4'], [3,'3'], [2,'2'], [1,'A']]
card_list_two = [[11,'A']]
suit_list_one = ['Spades', 'Hearts', 'Diamonds', 'Clubs']
suit_list_two = ['Spades', 'Hearts', 'Diamonds', 'Clubs']
test_string = """def test_{8:04d}_{0}{1}(self):
